...
public class UserDAO implements IUserDAO {
    ...
    private static final String SELECT_ALL_USERS_BY_COUNTRY = "select * from users where country = ?;";
    private static final String SORT_NAME = "select * from users order by name ASC";
    ...
    public List<User> selectUserByCountry(String country) {
        List<User> users = new ArrayList<>();
        try (Connection connection = getConnection();
             PreparedStatement preparedStatement = connection.prepareStatement(SELECT_ALL_USERS_BY_COUNTRY);) {
